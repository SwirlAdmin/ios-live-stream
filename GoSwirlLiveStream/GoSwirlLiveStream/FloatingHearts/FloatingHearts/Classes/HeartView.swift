...
open class HeartView: UIView {
    ...
    fileprivate func travelPath(inView view: UIView) -> UIBezierPath? {
        ...
        let viewHeight = view.bounds.height - 20
        ...
        //print("From Heart : ", travelDirection, xDelta, yDelta, controlPoint1, controlPoint2)
...
//UIImag
    override open func draw(_ rect: CGRect) {
        ...
        if let heartImage = UIImage(named: "heart", in: imageBundle, compatibleWith: nil) {
