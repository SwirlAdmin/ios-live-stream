...
public class DashboardViewController: UIViewController {
    ...
    public override func viewWillAppear(_ animated: Bool) {
        ...
        if Constants.getFetchDataStatusForPrevious() {
            if self.streamId != "" {
                //self.removeFetchCommentData(streamId: self.streamId)
            }
        }
    ...
    func fetchLiveStreamStatus(streamId: String) {
        ...
        //print("From fetchLiveStreamStatus ...")
        let databaseCollectionForLiveStream = Firestore.firestore().collection("live_streams")
        databaseCollectionForLiveStream.document(streamId).addSnapshotListener { querySnapshot, error in
            ...
            if index != nil {
                ...
                //print("From fetchLiveStreamStatus : ", checkLiveStatus)
                if checkLiveStatus == true {
                    //print("From fetchLiveStreamStatus ::: ", streamId)
            ...
            //print("From fetchLiveStreamStatus Constants.getLiveStreamStatus() : ", Constants.getLiveStreamStatus())
        }
    }
